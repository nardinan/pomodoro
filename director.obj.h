...
typedef struct s_director_action {
  d_list_node_head;
...
extern t_boolean
f_director_validator(struct s_object *self, double current_x, double current_y, double current_zoom, double *new_x, double *new_y, double *new_zoom);
...
d_declare_method(director, reload_collector)(struct s_object *self);
