...
void f_pomodoro_initialize_game(struct s_object *self, void **parameters, size_t entries) {
  ...
  if (module_buttons_container)
    d_call(environment, m_environment_del_drawable, module_buttons_container, d_ui_factory_default_level, e_environment_surface_ui);
  if (module_configuration_container)
    d_call(environment, m_environment_del_drawable, module_configuration_container, d_ui_factory_default_level, e_environment_surface_ui);
...
int pomodoro_load_call_complete(struct s_object *environment) {
  ...
  struct s_uiable_container *container, *button_configuration, *button_play, *button_quit;
  struct s_loader_attributes *loader_attributes = d_cast(loader, loader);
  ...
  d_try{
        ...
        if ((module_configuration =
               f_module_configuration_new(d_new(module_configuration), environment, loader_attributes->resources_json, loader_attributes->resources_png,
          ...
          d_call(environment, m_environment_add_drawable, module_buttons_container, d_ui_factory_default_level, e_environment_surface_ui);
        } else
