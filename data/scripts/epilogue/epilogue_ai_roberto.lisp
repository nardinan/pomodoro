...
;Code name  : robfuepilogu
;Location   : Unipg P1
;Author     : Nardinan
;Description: Roberto is completely fucked
...
(if (= server_disconnected 1.0)
  (begin
    ...
    (say "andrea" (get_dialog dialogs language 4) "robertofuepilogu_track4")) ;preview: Cool | looking at roberto
  (begin
    (say "roberto" (get_dialog dialogs language 1) "robertofuepilogu_track1") ;preview: Upload 'slave.bin', please w... | looking at Andrea
    (say "andrea" (get_dialog dialogs language 2) "robertofuepilogu_track2")) ;preview: Good, load it! | looking at roberto
  )
