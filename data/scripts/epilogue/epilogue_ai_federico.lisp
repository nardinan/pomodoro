...
;Code name  : federicofuepilogu
;Location   : Unipg P1
;Author     : Nardinan
;Description: federico is completely fucked
...
(if (= server_disconnected 1.0)
  (begin
    ...
    (say "andrea" (get_dialog dialogs language 4) "federicofuepilogu_track4")) ;preview: Cool | looking at federico
  (begin
