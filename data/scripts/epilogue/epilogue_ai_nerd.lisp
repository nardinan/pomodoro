...
;Code name  : nerdfuepilogu
;Location   : Unipg P1
;Author     : Nardinan
;Description: Nerd is completely fucked
...
(if (= server_disconnected 1.0)
  (begin
    ...
    (say "andrea" (get_dialog dialogs language 4) "nerdfuepilogu_track4")) ;preview: Cool | looking at nerd
  (begin
