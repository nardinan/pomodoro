...
(if (> show_chapters 0.0)
  (begin
    ...
    (if (= show_chapter_one 1.0)
      (effecteer_add "chapter_screen_animation" "intro_chapter_one" (+ 480 450) (+ 360 180) 10 0 t nil)
      (if (= show_chapter_two 1.0)
        (effecteer_add "chapter_screen_animation" "intro_chapter_two" (+ 480 450) (+ 360 180) 10 0 t nil)
