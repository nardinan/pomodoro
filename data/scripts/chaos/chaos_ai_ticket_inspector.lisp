...
;Location   : November
;Author     : Nardinan
;Description: Ticket inspector gives you a slice of the password
...
(if (= done_location 1.0)
  (director_dialog "game_ticket_inspector_first_0x0c")
  (if (= request_password 1.0)
    (director_dialog "game_ticket_inspector_after_0x0c")
    (director_dialog "game_ticket_inspector_first_0x0c")
    )
  )
