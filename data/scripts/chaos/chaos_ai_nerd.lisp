...
;Location   : UnipgA
;Author     : Nardinan
;Description: The nerd gives you the key of the temple
...
(define done_temple_key         (collector_get "done_temple_key"))
...
(if (= request_temple_key 1.0)
  (if (= done_temple_key 1.0)
    (director_dialog "game_nerd_done_0x0c")
    (if (= got_authorization 1.0)
      (director_dialog "game_nerd_requested_tool_0x0c")
      (if (= request_authorization 1.0)
        (director_dialog "game_nerd_requested_no_tool_0x0c")
        (director_dialog "game_nerd_activated_no_tool_0x0c")
        )
      )
    )
  (director_dialog "game_nerd_no_request_0x0c")
  )
