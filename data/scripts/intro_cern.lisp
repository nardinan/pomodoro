...
(talk "andrii"	(get_dialog dialogs language 0) "andrii_track1")
(talk "yuriy"	(get_dialog dialogs language 1) "yuriy_track1")
(director_wait_time 1)
(animation "yuriy" 	"still_right")
(stagecrafter_set_item "computer_A" "still_A")
(talk "yuriy"	(get_dialog dialogs language 2) "yuriy_track2")
(talk "andrii"	(get_dialog dialogs language 3) "andrii_track2")
(talk "yuriy"	(get_dialog dialogs language 4)	"yuriy_track3")
(animation "andrii" "back")
(stagecrafter_set_item "computer_C" "still_C")
(director_wait_time 1)
(animation "andrii" "still_left")
(talk "andrii"	(get_dialog dialogs language 5) "andrii_track3")
(talk "andrii"	(get_dialog dialogs language 6) "andrii_track4")
(talk "yuriy"  	(get_dialog dialogs language 7) "yuriy_track4")
(director_wait_time 1)
(talk "andrii" 	(get_dialog dialogs language 8)  "andrii_track5")
(talk "andrii" 	(get_dialog dialogs language 9)  "andrii_track6")
(talk "andrii" 	(get_dialog dialogs language 10) "andrii_track7")
(talk "yuriy" 	(get_dialog dialogs language 11) "yuriy_track5")
(animation "andrii" "back")
(talk "andrii"  (get_dialog dialogs language 12) "andrii_track8")
(talk "yuriy"   (get_dialog dialogs language 13) "yuriy_track6")
(director_wait_time 1)
(animation "andrii" "back_code")
(stagecrafter_set_item "computer_C" "coding_C")
(talk "andrii"  (get_dialog dialogs language 14) "andrii_track9")
(director_wait_time 1)
(stagecrafter_set_item "shutdown" "trigger")
(talk "andrii" 	(get_dialog dialogs language 15) "andrii_track10")
(animation "yuriy" 	"back_code")
(stagecrafter_set_item "computer_A" "coding_A")
(talk "yuriy" 	(get_dialog dialogs language 16) "yuriy_track7")
(talk "andrii" 	(get_dialog dialogs language 17) "andrii_track11")
...
(stagecrafter_set_item "computer_C" "still_C")
(director_wait_time 1)
(talk "yuriy"  	(get_dialog dialogs language 18) "yuriy_track8")
(animation "yuriy" 	"still_right")
(talk "yuriy"  	(get_dialog dialogs language 19) "yuriy_track9")
(animation "andrii"	"still_left")
(talk "andrii"  (get_dialog dialogs language 20) "andrii_track12")
(talk "yuriy"  	(get_dialog dialogs language 21) "yuriy_track10")
(director_wait_time 1)
(animation "andrii"	"back_code")
(stagecrafter_set_item "computer_C" "coding_C")
(talk "andrii" 	(get_dialog dialogs language 22) "andrii_track13")
(animation "yuriy" 	"back")
(talk "yuriy"  	(get_dialog dialogs language 23) "yuriy_track11A")
(talk "yuriy"  	(get_dialog dialogs language 24) "yuriy_track11B")
(talk "yuriy"  	(get_dialog dialogs language 25) "yuriy_track11C")
...
(stagecrafter_set_item "computer_C" "still_C")
(director_wait_time 2)
(talk "yuriy" 	(get_dialog dialogs language 26) "yuriy_track12")
(director_wait_time 2)
(puppeteer_move "andrii" 2240)
(talk_and_go "andrii" (get_dialog dialogs language 27) "andrii_track14A")
(talk_and_go "andrii" (get_dialog dialogs language 28) "andrii_track14B")
(talk_and_go "andrii" (get_dialog dialogs language 29) "andrii_track14C")
(director_wait_movement "andrii")
(animation "andrii" "back_code")
(stagecrafter_set_item "computer_B" "error_coding_B")
(talk "andrii" 	(get_dialog dialogs language 30) "andrii_track15")
(animation "yuriy" 	"still_right")
(talk "yuriy"  	(get_dialog dialogs language 31) "yuriy_track13A")
(talk "yuriy"  	(get_dialog dialogs language 32) "yuriy_track13B")
(talk "yuriy"  	(get_dialog dialogs language 33) "yuriy_track13C")
(talk "andrii" 	(get_dialog dialogs language 34) "andrii_track16A")
(talk "andrii" 	(get_dialog dialogs language 35) "andrii_track16B")
...
(director_wait_time 1)
(talk "yuriy"	(get_dialog dialogs language 36) "yuriy_track14")
(talk "andrii" 	(get_dialog dialogs language 37) "andrii_track17")
(animation "yuriy" 	"still_right")
(talk "yuriy" 	(get_dialog dialogs language 38) "yuriy_track15")
(animation "andrii"	"still_left")
(talk "andrii"	(get_dialog dialogs language 39) "andrii_track18")
(talk "yuriy"	(get_dialog dialogs language 40) "yuriy_track16")
(animation "andrii"	"back")
(talk "andrii"	(get_dialog dialogs language 41) "andrii_track19A")
(talk "andrii"	(get_dialog dialogs language 42) "andrii_track19B")
(talk "andrii"	(get_dialog dialogs language 43) "andrii_track19C")
(talk "andrii"	(get_dialog dialogs language 44) "andrii_track19D")
...
(director_wait_time 2)
(talk "yuriy"	(get_dialog dialogs language 45) "yuriy_track17")
(director_wait_time 1)
(animation "yuriy" "back")
(talk "yuriy"	(get_dialog dialogs language 46) "yuriy_track18")
(animation "yuriy" "still_right")
(talk "yuriy"	(get_dialog dialogs language 47) "yuriy_track19")
(animation "andrii" "still_left")
(talk "andrii"	(get_dialog dialogs language 48) "andrii_track20")
(talk "yuriy"	(get_dialog dialogs language 49) "yuriy_track20")
(talk "andrii"	(get_dialog dialogs language 50) "andrii_track21")
(talk "yuriy"	(get_dialog dialogs language 51) "yuriy_track21")
(talk "andrii"	(get_dialog dialogs language 52) "andrii_track22")
(animation "yuriy" "back")
(talk "yuriy"	(get_dialog dialogs language 53) "yuriy_track22")
(director_wait_time 1)
(animation "andrii" "back")
(director_wait_time 2)
(effecteer_play 	"dream" "dream_a_little_dream_of_me" 4000 4000)
(animation "yuriy" 	"still_right")
(talk "yuriy"	(get_dialog dialogs language 54) "yuriy_track23")
(animation "andrii" "still_left")
(talk "andrii"	(get_dialog dialogs language 55) "andrii_track23")
(director_wait_time 1)
